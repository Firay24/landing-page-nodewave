...
const Header = () => {
  ...
  return (
    <header className={`w-full sticky top-0 z-50 ${isScrolled && 'bg-black'}`}>
      <nav>
        <Container className="relative z-50 flex justify-between py-8">
          ...
          <Popover className='lg:hidden'>
            {({ open }) => (
              <>
                <Popover.Button
                  className="relative z-10 -m-2 inline-flex items-center rounded-lg stroke-gray-900 p-2 hover:bg-gray-200/50 hover:stroke-gray-600 active:stroke-gray-900 [&:not(:focus-visible)]:focus:outline-none outline-non"
