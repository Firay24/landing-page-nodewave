...
const baseStyle = {
    ...
    outline:
      "inline-flex justify-center border py-[calc(theme(spacing.2)-1px)] px-[calc(theme(spacing.3)-1px)] text-sm outline-2 outline-offset-2 transition-colors"
}
...
const variantStyles = {
  solid: {
    ...
    gray: "bg-[#00AD98] text-white hover:bg-gray-900 active:bg-[#00AD98] active:text-white/80",
  },
  outline: {
